...
$(document).ready(function() {
	$('body').ready(function(){ //Id del elemento cliqueable
		$('html, body').animate({scrollTop:195}, 2500);
		return false;
	});
});
</script>
 		...
 		<div id="contenido"> 
			...
			<div id="cabecera"> 
                ...
                <div id="divbotones" >
                    ...
                    <a href="#" class="enlinea izquierda"> Eliminar operador</a>
                </div>  
...
<form name="operador" action="logicadn.php?control=guardaroperador" method="post">
     ...
     <!--fin tabla formularios -->
		...
		<td>{$idtrabajo[$num]}</td>
		<td>{$estado[$num]}</td>
		<td><a href="logicadn.php?control=elitrbop&& id={$idtop}" onClick="return cofirmareliminar()" class="tabla" ><img src="/emarcosas/templates/img/eliminar.gif" height="16" width="16"/></a></td>
		{$num=$num+1}
		</tr>
		{/foreach}
	</tr>
