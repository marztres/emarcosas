...
$(function(){
	...
	//se configura el tiempo globar de expiracion en jquery.notify.js
		...
		if(contador>0)
		{
		create("withIcon", { title:'Mantenimiento!', text:'Hay Varias Maquinas para Cambio de aceite Inmediato  ,<a href="logicadn.php?control=maquinaria" class="ninguno" > Ver detalles</a> ', icon:'/emarcosas/templates/img/alert.png' },{ 
			expires:false
		});	
		}
