...
$(function(){
	...
	//se configura el tiempo globar de expiracion en jquery.notify.js
		create("default", { titulo:'Emarco Systems', text:' {$eoperador} '});
...
var pagina="logicadn.php?control=registrooperador&& id={$id}&& saldo={$saldo}"
...
<!--- container to hold notifications, and default templates --->
	<div id="container" style="display:none; top:40; left:0; bottom:auto; margin:auto; width:320px;">
