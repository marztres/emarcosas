...
$(function(){
	...
	//se configura el tiempo globar de expiracion en jquery.notify.js
		create("default", { titulo:'Emarco Systems', text:' {$pagarflu} '});
...
var pagina="logicadn.php?control=verdetallesfl&&id={$id}&&name={$nombre}&&saldo={$saldo}&&idpro={$idpro}&&combustible={$co}&&lubricante={$lu}"
...
<!--- container to hold notifications, and default templates --->
	<div id="container" style="display:none; top:40; left:0; bottom:auto; margin:auto; width:420px;">
