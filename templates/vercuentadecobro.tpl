  ...
  <table class="informacion"> 
   	...
   	<table class="formularios1">
		...
		<tr>
			...
			<td 	>	<input name="ciudad" type='text' id="ciudad" value='{$ciudad}' />   </td>    
			<td 	>	<input  name="fecha" type='text' class="fecha divorcio" id="fecha" value='{$fecha}'/>    </td>
            <td 	>	<input  name="numerodecuenta" type='text' id="numerodecuenta" value='{$cuentas}'  />    </td>
            <td 	>	<input  name="estado" type='text' class="estado " id="estado" value='{$estado}'/>    </td>
		</tr>
    </table>
        ...
        <tr class="sinfondo">	
            <td class="informacionbotones"> 
                ...
                <input type="hidden" name='ide' value='{$ide}' />
               	  <input name='cliente' type="text"  class="izquierda deudor-nombre autoescalable " id="cliente"  placeholder="Nombre persona o empresa " value="{$nombre_deudor}" />
                  <select class="izquierda identificacion1 noflotante " name='tidcliente' >
				    <option >C.C:</option>
						  <option>NIT:</option>
                  </select>
                  <input name='idcliente' type="text" class="izquierda " id="idcliente" placeholder="Identificacion" value="{$id_deudor}"/>
                </div>
                
                <div id="cobrante" class="izquierda"> 
               	  <label class="izquierda negrita cobrante-titulo "> Debe a: </label>
                      <input name='cobrante' type="text" class="izquierda noflotante cobrante-nombre autoescalable" id="cobrante"  placeholder="Nombre persona o empresa" value='{$nombre_cobrante}' />
                      <select class="izquierda identificacion2 noflotante " name='tidcobrante'>
                        <option>C.C:</option>
                              <option>NIT:</option>
                  </select>
                      <input name='idcobrante' type="text"  class="izquierda" id="idcobrante" placeholder="Identificacion" value='{$id_cobrante}'/>
                </div>
     			
                <div id="dineroenletras" class="izquierda "> 
               	  <label class="izquierda negrita dineroenletras-titulo" > La suma de: </label>
                      <input type="text" name='valorletras'  placeholder="Valor en letras" name='dletras' class="izquierda noflotante dineroenletras-caja autoescalable" value='{$valor_en_letras}'/> 
     ...
     <table class="controldemaquinas">
		...
		<tr>   
            ...
            <td>{$maquina}</td>
                ...
                <input class="izquierda formadepago-caja autoescalable " placeholder="Forma de pago" name='despago' value="{$forma_pago}"> </input>    
                
                </div>
                
                <div id="datosdecobro" class="izquierda"> 
                	<label class="izquierda negrita "> Coordialemte, </label>
                    <input name='nombre' type="text" class="izquierda noflotante autoescalable" id="nombre" placeholder="Nombre " value='{$nombre_responsable}'/>
                    <input name='cedula' type="text" class="izquierda noflotante autoescalable " id="cedula" placeholder="Cedula" value="{$id_responsable}"/>
                    <input name='telefono' type="text"  class="izquierda noflotante autoescalable " id="telefono" placeholder="Telefono" value="{$telefono_responsable}"/>
                    <input name='direccion' type="text" class="izquierda noflotante autoescalable " id="direccion" placeholder="Dirección" value="{$direccion_responsable}"/>
