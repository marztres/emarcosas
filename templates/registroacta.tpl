...
<link href="/emarcosas/templates/css/registrodeactas.css"  type="text/css"  rel="stylesheet" media="all"  /> 
	...
	<div id="cuerpo"> 
		...
		<div id="cabecera"> 
				<div id="head" > 	
                    ...
                    <!--titulo seccion -->
                    <h2 class="head-h2down izquierda noflotante"> Control de actas de pago </h2>
			    	<!-- fin titulo seccion -->
                </div>
				<!--fin head -->
                ...
                <div id="divbotones" >
                    ...
                    <a href="logicadn.php?control=actasdepagos" class="enlinea">
                    	<img src="/emarcosas/templates/img/botonactadepago.png" width="23" height="23"  class="enlinea izquierda"/> 
                    </a>
                    <a href="logicadn.php?control=actasdepagos&& idc={$idc}" class="enlinea izquierda">Agregar acta de pago</a>
...
<div id="login">
    ...
    <table class='controldemaquinas example izquierda'>
 			  ...
 			  <td class='tipomaquina fondocabeza' ><strong>Id</strong></td>
                  <td class='idmaquina fondocabeza' > <strong>Tipo</strong></td> 
                  <td class='trabajomaquina fondocabeza' ><strong>Opción</strong></td>
                  <td class='registromaquina fondocabeza'> <strong>valor</strong></td>
                  <td class='notificacion fondocabeza'><strong>Fecha</strong></td>
			     ...
			     <tr><td>{$id}</td>
                 <td>{$tipo[$num]}</td>
                 <td><a href="logicadn.php?control=modificaracta&& id={$id}&& idc={$idc}" class="tabla">Modificar</a></td>	
                 <td>{$valor[$num]}</td>
                 <td>{$fecha[$num]}</td>
                 <td class="basura"><a href='logicadn.php?control=eliacta&& id={$id}&& idc={$idc}' onClick="return cofirmareliminar()" ><img src="/emarcosas/templates/img/eliminar.gif" height="16" width="16"/></a></td>
                 </tr>
                 {$num=$num+1}
                 {/foreach}
                 </tr>
