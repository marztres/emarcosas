...
<div id="login">
	<table class="informacion"> 
     ...
     <table class="formularios ">
		...
		<tr>
			<td 	> <input name="cedula" type="text" id="cedula" value="{$id}"  /></td>    
			<td 	>   <input name="nombres" type="text" id="nombres" value="{$nombre}" />    </td>
			<td  	>  <input name="apellidos" type="text" id="apellidos" value="{$apellido}" />   </td>
        ...
        <tr>
			...
			<td 	> <input name="direccion" type="text" id="direccion" value="{$direccion}"/>	  </td>
     ...
     <!--fin tabla formularios -->
         ...
         <td class="fondocabeza"> 
     	 ...
     	 <tr class="sinfondo">	
			...
			<input name="sueldo" type="text" class="cajasueldo" id="sueldo" value="{$sueldo}" />
