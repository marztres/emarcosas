<?php /* Smarty version Smarty-3.1.10, created on 2012-09-21 16:37:37
         compiled from "templates\cuentadecobro.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7068505c97d1ca73c5-80732804%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ab850579e15025963af7c83facb85823b0ccebd6' => 
    array (
      0 => 'templates\\cuentadecobro.tpl',
      1 => 1347315441,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7068505c97d1ca73c5-80732804',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_505c97d1e38382_39023039',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_505c97d1e38382_39023039')) {function content_505c97d1e38382_39023039($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  ...
  <table class="informacion"> 
    	<tr> 
        	<td class="fondocabeza"> 
            	<p class="negrita tituloinfosup">
                   ...
                   <?php if ($_smarty_tpl->tpl_vars['mensajeid']->value==''){?>
                   <?php }else{ ?>
   	...
   	<table class="formularios1">
		...
		<tr>
            ...
            <td 	>	<input  name="numerodecuenta" type='text' id="numerodecuenta" value='<?php echo $_smarty_tpl->tpl_vars['idcuentas']->value;?>
'  />    </td>
        ...
        <tr class="sinfondo">	
            <td class="informacionbotones"> 
            	<div id="infoadicional" class="izquierda"> 
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['valor_pendiente']->value==0){?>
                    <?php $_smarty_tpl->tpl_vars['valor_pendiente'] = new Smarty_variable($_smarty_tpl->tpl_vars['valor']->value, null, 0);?>
                    <?php }?>
