<?php /* Smarty version Smarty-3.1.10, created on 2012-09-22 22:24:20
         compiled from "templates\modificaroperador.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22233505e3a94240f44-15792762%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc29b3f2d23f22f4128937027fb9769696de59ca' => 
    array (
      0 => 'templates\\modificaroperador.tpl',
      1 => 1346961653,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22233505e3a94240f44-15792762',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_505e3a943e6e26_77124169',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_505e3a943e6e26_77124169')) {function content_505e3a943e6e26_77124169($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<form name="operador" action="logicadn.php?control=modificaoperador" method="post" ONSUBMIT='return pregunta_operador();' >
<div id="login">
	<table class="informacion"> 
     ...
     <table class="formularios ">
		...
		<tr>
			<td 	> <input name="cedula" type="text" id="cedula" value="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
"  /></td>    
			<td 	>   <input name="nombres" type="text" id="nombres" value="<?php echo $_smarty_tpl->tpl_vars['nombre']->value;?>
" />    </td>
			<td  	>  <input name="apellidos" type="text" id="apellidos" value="<?php echo $_smarty_tpl->tpl_vars['apellido']->value;?>
" />   </td>
			<td 	>  <input name="edad" type="text" id="edad" value="<?php echo $_smarty_tpl->tpl_vars['edad']->value;?>
"/>     </td>
			<td 	>   <select name="sexo" class="sex">
...
"/>	        </td>    
			<td 	> <input name="direccion" type="text" id="direccion" value="<?php echo $_smarty_tpl->tpl_vars['direccion']->value;?>
"/>	  </td>
			<td  	> <input name="correo" type="text" id="correo" value="<?php echo $_smarty_tpl->tpl_vars['correo']->value;?>
"/>   </td>
        </tr>
     ...
     <!--fin tabla formularios -->
         ...
         <td class="fondocabeza"> 
     	 ...
     	 <tr class="sinfondo">	
			...
			<input name="sueldo" type="text" class="cajasueldo" id="sueldo" value="<?php echo $_smarty_tpl->tpl_vars['sueldo']->value;?>
" />
         ...
         <tr class="sinfondo">	
        	...
        	<input type="submit"  class="izquierda cajaagregarop" onclick="MM_validateForm('cedula','','RisNum','nombres','','R','apellidos','','R','edad','','R','telefono','','RisNum','direccion','','R','correo','','RisEmail','sueldo','','RisNum');return document.MM_returnValue" value="Modificar" />
